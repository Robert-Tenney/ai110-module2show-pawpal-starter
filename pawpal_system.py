...
Classes: TaskDetail, Task, Pet, Owner, DailySchedule, Scheduler.

Phase 4 additions
-----------------
* Scheduler.sort_by_time()        – sort tasks by scheduled time via lambda key
* Scheduler.filter_tasks()        – filter by pet name and/or completion status
* Task.mark_complete()            – now spawns a next-occurrence Task for recurring tasks
* Scheduler.detect_conflicts()    – lightweight exact-time collision detector
"""
